...
//       } else {
//         // If comment is not provided in the request body, return an error or handle it accordingly
//         res.status(400).json({ error: 'Comment is required for update' });
//       }
//     } else {
//       // If not exists, create a new interaction
...
//   console.log(req.body.email, req.body.action, req.params.likedItemId )
//   try {
